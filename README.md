...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f88a3262-6f20-41ce-9b1a-3b07aa873caa
```

> `f88a3262-6f20-41ce-9b1a-3b07aa873caa` is the password of the certificate, you can change it to any password you want.
